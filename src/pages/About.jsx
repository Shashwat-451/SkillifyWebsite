  ...
  return (
    <div>
      ...
      <section className="border-b border-richblack-700">
        <div className="mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10  0">
        ...
        <div className="mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 ">
          <div className="flex flex-col items-center gap-10 lg:flex-row justify-between">
            <div className="my-24 flex lg:w-[50%] flex-col gap-10">
              <h1 className=" -gradient-to-br from-[#833AB4] via-[#FD1D1D] to-[#FCB045]  -clip-text text-4xl font-semibold   lg:w-[70%] ">
                Our Founding Story
              </h1>
          ...
          <div style={{marginTop:"-50px"}} className="flex flex-col items-center lg:gap-10 lg:flex-row justify-between theme text-white pl-5">
            ...
            <div  className="my-24 flex lg:w-[40%] flex-col gap-10">
              <h1 className=" -gradient-to-b from-[#1FA2FF] via-[#12D8FA] to-[#A6FFCB]    -clip-text text-4xl font-semibold lg:w-[70%] ">
              Our Mission
              </h1>
              <p className="text-base font-medium   lg:w-[95%]">
